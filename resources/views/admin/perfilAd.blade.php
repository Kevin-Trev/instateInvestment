  ...
  <div class="row">
    ...
    <div class="card col-md-3 col-lg-3 mx-auto">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nombre" value="Carlos Enrique Trejo Avila" disabled>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="fecha-nacimiento" value="21 de julio de 1963" disabled>
      </div>
      <!-- GENERO -->
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="telefono" value="8713428967" disabled>
      </div>
      <!-- SUSPENDER -->
      <div class="mb-3">
        <button class="property-button btn btn-primary"  onclick="alert('aun no jala papoi')">SUSPENDER</button>
      </div>
    </div>
      ...
      <div class="property-list" id="pl">
        ...
        <div class="card" style="margin-top: 5px;">
          <div class="row">
            ...
            <div class="col-md-2">
              <button style="margin-bottom: 10px;" class="bt-blue" onclick="alert('aun no jala papoi')">REVISAR</button>
            </div>
          </div>
        </div>
        <!-- PROPIEDAD 2 -->
